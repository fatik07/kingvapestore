...
class CategoryController extends Controller
{
    ...
    {
        $data = $request->all();
        // membuat slug sesuai dengan nama nya
        $data['slug'] = Str::slug($request->name);
        // mengambil data foto
        $data['photo'] = $request->file('photo')->store('assets/category','public');
        // kemudian kita create data nya
    ...
    {
        $item = Category::findOrfail($id); // jika tidak ditemuakan akan ke 404
    ...
    public function update(CategoryRequest $request, $id)
    {
        ...
        // mengambil data foto
        $data['photo'] = $request->file('photo')->store('assets/category','public');
        // buat menemukana data jika ditemuakan atau tidak
